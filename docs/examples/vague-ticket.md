...
This is a common input in support, QA, product, and engineering workflows.
...
Before generating a task, DIF asks for missing context.
...
DIF treats this as a correction, not as a new unrelated prompt.
